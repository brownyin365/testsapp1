...
class MenuBuilder:
    ...
    def main_menu(user_id):
        ...
        # referral_stats_button = InlineKeyboardButton("📊 View Referral Stats", web_app={"url": f"https://31c1-154-160-14-57.ngrok-free.app/referral_stats/{user_id}"})
        

        # view_app_stats = InlineKeyboardButton(
        #     "📋 View App Statistics",
        #     web_app={"url": f"https://31c1-154-160-14-57.ngrok-free.app/user_signins/{user_id}"}
        # )
